...
public interface CourseVideoDao {
     ...
     * @return 对象列表
     */
    List<CourseVideo> queryAllByLimit(@Param("offset") int offset, @Param("limit") int limit);
     ...
     * @return 对象列表
     */
    List<CourseVideo> queryAll(CourseVideo courseVideo);
     ...
     * @return 影响行数
     */
    int update(CourseVideo courseVideo);
